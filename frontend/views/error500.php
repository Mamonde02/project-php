...
<body class="bg-gray-50 min-h-screen flex items-center justify-center px-4">
    <div class="max-w-md w-full space-y-8 text-center bg-white shadow-md rounded-lg p-12">
        ...
        <!-- Heading -->
        <h1 class="text-3xl font-extrabold text-gray-900">Server Error 500!</h1>

        <!-- Message -->
        <p class="mt-2 text-gray-600">Something went wrong on our server side. Please try again later.</p>
